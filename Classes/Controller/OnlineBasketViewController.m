...
- (void)viewWillAppear:(BOOL)animated {
	...
	[onlineBasketView setContentOffset:CGPointMake(0, 0) animated:NO];
	
	/* show the overlay view */
	[DataManager showOverlayView:onlineBasketView];
...
- (void)updateOnlineBasketDetails {
	...
	waitingForAPI = NO;
	[onlineBasketView reloadSections:[NSIndexSet indexSetWithIndex:0] withRowAnimation:UITableViewRowAnimationNone];
